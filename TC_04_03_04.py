...
browser.implicitly_wait(6)
#click category name of 1st entry
time.sleep(4)
browser.find_element_by_css_selector("#publishedProductGrid > div > catalog-published-product-grid > md-content > md-card > md-table-container > table > tbody > tr:nth-child(1) > td:nth-child(4) > div > span").click()
# click the category again to open dropdown
browser.find_element_by_css_selector("#publishedProductGrid > div > catalog-published-product-grid > md-content > md-card > md-table-container > table > tbody > tr:nth-child(1) > td:nth-child(4) > div > form > div > select").click()
#select a random category
browser.implicitly_wait(6)
newCategory = Select(browser.find_element_by_css_selector("#publishedProductGrid > div > catalog-published-product-grid > md-content > md-card > md-table-container > table > tbody > tr:nth-child(1) > td:nth-child(4) > div > form > div > select"))
newCategory.select_by_index(randint(1, 32))
browser.implicitly_wait(6)
#click outside
...
subCategory.select_by_index(randint(1, len(options) - 1))
