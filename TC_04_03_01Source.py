...
uname.send_keys("intrigo.demouser@gmail.com")
pwd.send_keys("intrigo123")
...
browser.find_element_by_xpath("/html/body/div[3]/md-select-menu/md-content/md-option[3]").click() #select the same store
browser.implicitly_wait(6)
#Published tab
...
#browser.find_element_by_css_selector("#validProducts > tbody > tr:nth-child(1) > td:nth-child(2) > div > span").click()
#browser.find_element_by_xpath("//*[@id='validProducts']/tbody/tr[1]/td[2]/div/span").click()
...
#copied from publishProductSource
    ...
    if skuname == (browser.find_element_by_xpath("//*[@id='pendingValidationGrid']/tbody/tr["+str(n)+"]/td[2]/div/span[2]/a").get_attribute("text")):
        ...
        for m in range (1,6):
            if skuname == (browser.find_element_by_css_selector("#validProductGrid > div > valid-products-grid > md-content > md-card > md-table-container > table > tbody > tr:nth-child("+str(m)+") > td:nth-child(3) > div > span:nth-child(2) > a").get_attribute("text")):
                print("hi")
                browser.find_element_by_xpath("//*[@id='validProductGrid']/div/valid-products-grid/md-content/md-card/md-table-container/table/thead[1]/tr["+str(m)+"]/th[1]/md-checkbox/div[1]").click()
