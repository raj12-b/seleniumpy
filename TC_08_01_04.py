...
browser.find_element_by_css_selector("#fileInput").send_keys("C:/Users/WINDOWS/Documents/Automation/Inventory/TC_08_01_04.xlsx")
#toastr message
...
#get quantity
qty = browser.find_element_by_css_selector("#productGrid > inventory-price-products-grid > md-content > md-card > md-table-container > table > tbody > tr > td:nth-child(6) > span:nth-child(1)").get_attribute("innerHTML")
if qty is '0':
    print("File is uploaded without quantity")
else:
