...
#number of entries
entriesCount = browser.find_element_by_css_selector("#productGrid > inventory-price-products-grid > md-content > md-card > md-table-pagination > div.buttons > div").get_attribute("innerHTML")
#print("count is", entriesCount)
if entriesCount == '0 - 0 of 0':
