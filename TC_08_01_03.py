...
browser.find_element_by_css_selector("#fileInput").send_keys("C:/Users/WINDOWS/Documents/Automation/Inventory/TC_08_01_02.xlsx")
#toastr message
...
#get country of first entry
country1 = browser.find_element_by_css_selector("#productGrid > inventory-price-products-grid > md-content > md-card > md-table-container > table > tbody > tr:nth-child(1) > td:nth-child(10) > span:nth-child(1)").get_attribute("innerHTML")
if country1 is '':
    print("No country")
else:
    print("Country is", country1)
print("exit")