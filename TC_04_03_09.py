...
time.sleep(3)
#get old value
unspsc = browser.find_element_by_css_selector("#publishedProductGrid > div > catalog-published-product-grid > md-content > md-card > md-table-container > table > tbody > tr:nth-child(1) > td:nth-child(7) > div > span").text
#click unspsc
browser.find_element_by_css_selector("#publishedProductGrid > div > catalog-published-product-grid > md-content > md-card > md-table-container > table > tbody > tr:nth-child(1) > td:nth-child(7) > div > span").click()
#enter new value by incrementing old value by 1
unspsc = int(unspsc, 10) + 1 #value of unspsc in string, converting to int of base 10 and adding 1
print(unspsc)
#clear unspsc field
browser.find_element_by_css_selector("#publishedProductGrid > div > catalog-published-product-grid > md-content > md-card > md-table-container > table > tbody > tr:nth-child(1) > td:nth-child(7) > div > form > div > input").clear()
#change the UNSPSC
browser.find_element_by_css_selector("#publishedProductGrid > div > catalog-published-product-grid > md-content > md-card > md-table-container > table > tbody > tr:nth-child(1) > td:nth-child(7) > div > form > div > input").send_keys(str(unspsc))
#click outside
